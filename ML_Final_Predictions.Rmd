...
It measures the model's performance on unseen data, providing an indication of how well the model will generalize beyond the training set. A low out-of-sample error **`r sprintf("%.4f (%.2f%%)", oos_error, oos_error * 100)`** suggests that the model is not overfitting and is likely to perform well on new data.
